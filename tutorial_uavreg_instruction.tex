...
\tikzset{io/.style={
    draw=none,minimum width=0mm,minimum height=0mm}}
...
(Todo) Zie de documentatie in het voorbeeld \texttt{quadcopter\_sim.py} en het overzicht van de variabelen in Tabel~\ref{tab:symbol}. 
\begin{table}
